...
export default function DisplayCareers() {
    ...
    let i=1;
     ...
     const handleDelete=async(e)=>{
      ...
      if (window.confirm(text) === true) {
        try{
            const res = await axios.delete("/career/"+e);
            alert(res.data);
  ...
  <div class='col-lg-12'>
    <div class='card'>
      <div class='card-body'>
        <h5 class='card-title'>Display Careers</h5>
            ...
            <table id="example" class="table table-striped dt-responsive nowrap w-100">
              ...
              {career.map((career)=>(
                     <tr>
                         ...
                         <td>
                             <button className="delete" onClick={()=>handleDelete(career.career_id)}>Delete</button>
                         </td>
                         {/* <td>
    //                         <button className="edit"><Link to={`/Updatecareer/${career.career_id}`}>Edit</Link></button>
    //                     </td> */}
