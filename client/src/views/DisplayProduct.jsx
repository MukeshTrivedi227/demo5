...
//     <div class='card'>
//       <div class='card-body'>
//         <h5 class='card-title'>Display Product</h5>
          ...
          {products.map((product)=>
                   <tr>
                    ...
                    <td scope="row">{i++}</td>
                     ...
                     {/* <td>{product.product_description}</td> */}
                     <td>{product.status}</td>
                     <td> <img src={"/upload/"+product.product_image} alt='mukesh' width="100" height="100"></img> </td>
                                           
                     <td>
                         <button className="delete" onClick={()=>handleDelete(product.product_id)}>Delete</button>
                         &nbsp;&nbsp;
                         <button className="edit"><Link to={`/product/${product.product_id}`}>Edit</Link></button>
                     </td>
